...
task gen_bindings, "Generate bindings":
  ...
  echo "- \"byte\" has been redefined"
  echo "- The following ptr+len pairs should be replaced by openarray[byte]:"
  echo "  - msg: ptr byte; msg_len: uint"
  echo "  - DST: ptr byte; DST_len: uint"
  echo "  - aug: ptr byte; aug_len: uint"
  echo "  - IKM: ptr byte; IKM_len: uint"
  echo "  - info: ptr byte; info_len: uint"
  echo "- blst types should use byref and remove ptr usage for var or no modifier."
